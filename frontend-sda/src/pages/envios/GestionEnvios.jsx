...
const GestionEnvios = () => {
    ...
    const acciones = [
        {
            titulo: "Nuevo Envío",
            descripcion: "Registrar una nueva solicitud de despacho y generar etiqueta.",
            icono: <PackagePlus size={32} />,
            ruta: "/envios/nuevo",
            color: "cyan",
        ...
        },
        {
            ...
            descripcion: "Monitorizar estado en tiempo real y trazabilidad completa.",
        ...
        {
            titulo: "Gestión de Remitos",
            descripcion: "Auditoría, control y descarga de documentación oficial.",
            ...
            <Group justify="space-between" align="flex-end" mb={50}>
                <Box>
                    ...
                    <Text c="dimmed" size="lg" mt={5} maw={600} lh={1.4}>
                        Control centralizado de operaciones. Despacha, monitorea y audita tus envíos desde un solo lugar.
                    </Text>
                </Box>
            </Group>
